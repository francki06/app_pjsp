...
import 'package:pjsp/modele/Fichier_solde_model.dart';
import 'Solde_fichier_list.dart';

class Solde_dossier_list extends StatelessWidget {
  final String id;
  final String nom;
  final List<Fichier_solde_model> fichier;
